...
module.exports.handleEvent = async ({ event, api, Users }) => {
  ...
  if (event.body) {
    ...
    const session =
      ...
      }, 10000); // 3000 milliseconds (3 seconds) delay for the initial message
